...
const cityAction = actions.city;
const latAction = actions.lat;
const lonAction = actions.lon;
const setAllAction = actions.setAll;
...
export default function InputFields() {
  ...
  useEffect(() => {
    if (masterState) dispatch(setAllAction(masterState));
    else dispatch(setAllAction(initalInputState));
  }, []);
  ...
  return (
    <form
      ...
      className={style["input__fields"]}
      style={{ gridArea: "input_fields" }}
    >
